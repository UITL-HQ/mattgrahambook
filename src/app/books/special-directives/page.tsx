...
const book = getBookBySlug("special-directives")!;

export const metadata: Metadata = {
  title: "Special Directives — A Courthouse Thriller",
  description: book.description,
  openGraph: {
    title: "Special Directives by Matt Graham",
    description: book.description,
      ...
      <section className="bg-cream">
        <div className="mx-auto max-w-6xl px-6 py-16 text-center">
          ...
          <p className="text-text-secondary mb-8 max-w-lg mx-auto">
            The first installment in The Van Nuys Courthouse Legal Thriller
            Series. 4.6 stars on Amazon and Reader&apos;s Favorite Award Winner.
          </p>
          <Link
            href="/books/hidden-behind-the-robe"
